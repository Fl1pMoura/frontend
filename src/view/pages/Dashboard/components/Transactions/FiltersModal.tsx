    ...
    <Modal open={ isModalVisible } onClose={ handleModalVisibility } title="Filtros" >
      <div className="text-gray-800">
        ...
        <div className="space-y-2 mt-2">
          <button className="w-full rounded-2xl h-10 text-left tracking-[-0.5px] flex items-center hover:bg-gray-50 p-2 transition-all">
            Nubank
          </button>
          <button className="w-full rounded-2xl h-10 text-left tracking-[-0.5px] flex items-center hover:bg-gray-50 p-2 transition-all">
            Xp
      ...
      <div className="text-gray-800 my-10">
        ...
        <div className="mt-2 flex items-center justify-between max-w-[210px]">
          ...
          <div className="flex-1 text-center">
            <span className="font-medium text-sm tracking-[-0.5px]">2024</span>
          </div>
          <button className="size-12 flex items-center justify-center">
